...
# It's just another list to test the functions
PY_CONTENT_CREATORS = [
    'brian okken',
    'michael kennedy',
    'trey hunner',
...
# Just create functions with prefix test
...
def test_dedup_title_case_names_different_list():
...
def test_sort_by_surname_desc_different_list():
...
def test_shortest_first_name_different_list():
